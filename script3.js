async function findProcedure() {
    ...
    // Group the department checks together to ensure proper logical operation
    const matchingProcedures = procedures.filter(procedure =>
        ...
        procedure['Injury Code'].includes(injuryCode)
    );

    // Debugging line to see the output of the filter function
    console.log(matchingProcedures);
